...
\begin{question}{
  ...
  A másodrendű (fizikai, intramolekuláris) kötés az elsőrendű (kémiai,
  intermolekuláris) kötéseknél jóval kisebb energiájú kötés, mégis nagy
  jelentősége van a polimereknél.
  \tcbline
...
\begin{question}{
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      node[above] {
        \textcolor{cyan!50!black}{$\sigma_H$},
        \textcolor{yellow!50!black}{$\eta$}};

      \draw[domain=0:4.5, smooth, variable=\x, yellow!50!black, ultra thick]
      plot ({\x}, {.05*exp(\x)});
      \draw[domain=0:5.5, smooth, variable=\x, cyan!50!black, ultra thick]
      plot ({\x}, {2*ln(\x+1)});
    \end{tikzpicture}
...
\begin{question}{
  ...
  lehet őket sem alakítani, sem megömleszteni. Az amorf fázisban a legnagyobb a
  molekulák közötti szabad térfogat, ami kis sűrűséget eredményez, és nagy
  deformációkat tesz lehetővé.
\end{question}
...
\begin{question}{
  ...
  szabályos rendben helyezkednek el. Egyértelmű síklapokkal nem határolható.
  \textbf{Opálosság} jellemző rájuk. Kristályos polimerek mindig tartalmaznak
  amorf részt is. Kb. $70\%$-os kristályos részarányig jól használható	a
  \textbf{rojtos micella modell}. Eszerint túlhűtés hatására beindul a
  \textbf{felhajtogatódás}, mely során a láncok párhuzamosan hajtogatódnak fel,
  \textbf{krisztallitok} (lamella) alakulnak ki.
\end{question}
...
\begin{question}{
  ...
  \begin{figure}[H]
    % By Roland.chem - Own work, CC0, https://commons.wikimedia.org/w/index.php?curid=37866505
    \centering
    \includegraphics[width=.3\textwidth]{./static/rojtos-micella.pdf}
    \caption{Rojtos micella modell\cite{bib:rojtos}}
    \label{fig:micella}
  \end{figure}
  \tcbline
...
\begin{question}{
  ...
  Méretük: $d = 5\,\mu\text{m} \dots 5\,\mathrm{mm}$.
\end{question}
...
\begin{question}{
  ...
  \begin{itemize}
    ...
    \item Mezoszkópikus szerkezet (szuperkristályok, átmenen nm és \textmu m
          között)
    \item Finomszerkezet
...
\begin{question}{
  ...
  állapota meegyezik (\textbf{egységes}). A fázisdomén egy összefüggő területe
  az anyagnak.
  \tcbline
...
\begin{question}{
  ...
  \begin{figure}[H]
    ...
    \end{subfigure}
    \hfill
    \caption{Lineáris amorf anyagok és elasztomerek összehasonlítása}
    \label{fig:comp1}
  \end{figure}
\end{question}
...
\begin{question}{
  ...
  \begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{\textcolor{cyan!50!black}{Láncreakció} és
      \textcolor{yellow!50!black}{lépcsős eljárások} koverziós diagramja}
...
\begin{question}{
  ...
  \begin{itemize}
    \item Szabadeséselvű – buktatott hordó (betonkeverő)
    \item Eltoláselvű – keverő forgó lapáttal (kaszkádreaktor)
    \item Repítéselvű – nagysebességű örvényes keverő (turmixgép)
    \item Eltolás és repítéselvű – Fekvő henger (shredder)
    \item Vándorcsigával ellátott kúpos siló
          \begin{itemize}
...
\begin{question}{
  ...
  \begin{figure}[H]
    ...
    \caption{Extrúder\cite{bib:laborok}}
    \label{fig:extruder}
  \end{figure}
\end{question}
...
\begin{question}{
  ...
  \begin{figure}[H]
    ...
    \begin{subfigure}[b]{.60\textwidth}
      \centering
      \includegraphics[height=38mm]{./static/extruder-csiga1.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{.35\textwidth}
      \centering
      \includegraphics[height=38mm]{./static/extruder-csiga2.png}
    \end{subfigure}
    \hfill
    \caption{Extrúdercsigák\cite{bib:laborok}}
  ...
  \begin{itemize}
    ...
    \item Kompressziós szakasz
          \begin{itemize}
            \item anyag megömlesztése (cirkulációs áramlások, meleg hengerfal)
            \item megfelelő nyomás biztosítása (magprogresszív/szögdegresszív)
            \item kompressziós arány jellemzően: $1,75\dots 3$
          \end{itemize}
    \item Homogenizáló szakasz
          \begin{itemize}
            \item egyenletes hőeloszlatás és gáztalanítás, nem csak a végén
                  lehet
          \end{itemize}
  \end{itemize}
  \tcbline
...
\begin{question}{
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.35\textwidth]{./static/extruder-aramlasok.png}
    \caption{Áramlási viszonyok a homogenizáló zónában\cite{bib:laborok}}
    \label{fig:extruderV}
  \end{figure}
  \[
  ...
  \textbf{Keveredés} az \textbf{örvényesség} miatt alakul ki. A
  \textbf{törötárcsa} és \textbf{szűrőbetét} a torlóáramot növelik.
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}[ultra thick, scale=.5]
...
\begin{question}{
  ...
  Az \textbf{ömledékáram} egy körszimmetrikus magot, a (tartóbakok tartotta)
  \textbf{torpedót} megkerüli, majd a végső méretre szűkítve hagyja el a
  szerszámot.
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.9]{./static/csogyartas.png}
    \caption{A csőgyártás szerszáma\cite{bib:laborok}}
...
\begin{question}{
  ...
  \begin{figure}[H]
    ...
    \caption{A szélesrésű szerszám\cite{bib:laborok}}
...
\begin{question}{
  ...
  \begin{figure}[H]
    ...
    \caption{A fröccsöntőgép részei\cite{bib:laborok}}
    \label{fig:froccs}
  \end{figure}
  \begin{enumerate}
  ...
  \end{enumerate}
  A fröccsöntőgép csigája axiálisan el tud mozogni (hidraulikus dugattyú),
  jóval nagyobb nyomásokat és hőmérsékleteket tud elviselni. Van rajta
  visszaáramlásgátló.
  \tcbline

  \underline{\textbf{\textit{Feldolgozott anyagok és adalékanyagok:}}} \\[2mm]
  Alapanyagok: PE, PP, PVC, PET, PS, PUR, \textbf{ABS}, alifás PA \\[2mm]
  Adalékanyagok: színezék, antisztatizáló, égésgátló
  \tcbline

  \underline{\textbf{\textit{M3 laborgyakorlat:}}}
  \begin{table}[H]
    \centering\begin{tabular}{l l}
      Alapanyag:   & ABS                   \\
      Hőmérséklet: & $230^\circ\mathrm{C}$ \\
      Nyomás:      & $1000 \,\mathrm{bar}$ \\
      Termék:      & Kimérő
    \end{tabular}
  \end{table}
\end{question}
...
\begin{question}{
  ...
  \begin{itemize}
    ...
    \item[1–2,] \textbf{befröccsöntés}, nyomás egyre nő
    \item[2–3,] átkapcsolás \textbf{utónyomásra} (veszteség), hűtés kezdete
    \item[  4,] \textbf{lepecsételődési} pont (legszűkebb keresztmetszetben
      megszilárdul)
    \item[4–5,] \textbf{izochor} hűl (állandó fajtérfogat)
    \item[  5,] atmoszférikus nyomás elérése
      % \item[5–6,] \textbf{izobár} hűl, szerszám még \textbf{csukva}
    \item[5–6–7,] \textbf{izobár} hűl, szerszám először zárva, majd nyitva –
      \textbf{zsugorodás}
  \end{itemize}
  \begin{figure}[H]
    \centering
    \includegraphics{./static/amorffroccs.png}
    \caption{Amorf polimerek $pvT$ diagramja\cite{bib:laborok}}
    \label{fig:pvT}
  \end{figure}
\end{question}
...
\begin{question}{
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.9]{./static/extruzios_fuvas.png}
    \caption{Extrúziós fúvás folyamata\cite{bib:eloadas}}
    \label{fig:extr}
  \end{figure}
  ...
  a cső alját levágja, a felesleget leszedi. Leggyakrabban HDPE-ből (nagy
  ömledékszilárdság miatt) állítunk elő $0,1\dots50\,\mathrm{l}$-es palackokat,
  tartályokat, gyógyszercsomagolásokat. (termék a HDPE miatt nem lehet
  átlátszó)
\end{question}
...
\begin{question}{
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.6]{./static/froccs_fuvas.png}
    \caption{Fröccsfúvás folyamata\cite{bib:eloadas}}
    \label{fig:froccsfuvas}
  \end{figure}
  ...
  fiola alját \textbf{előmelegítik} ($T_g$ fölé), esetenként tüskével
  \textbf{előnyújtják}, majd \textbf{forró levegőt fújnak} bele. A készterméken
  nincsen hegedés, viszont alján \textbf{lepecsételődés} található. A terméken
  nem lehet fogantyú, a gyártás \textbf{szakaszos}.
\end{question}
...
\begin{question}{
  ...
  \begin{itemize}
    \item Üvegszál
          \begin{itemize}
            \item[$\circ$] $55-65\%$ \chemfig{SiO_2}-ből és egyéb fémoxidokból
  ...
  \underline{\textit{\textbf{Mátrixanyag:}}}
  \begin{itemize}
    \item Propilén – hőre lágyuló
    \item Polieszter – műgyanta
    \item Epoxigyanta
  \end{itemize}
  \tcbline
...
\begin{question}{
  ...
  \end{multicols}
  \begin{itemize}
    \item SLS (szelektív lézer szinterézis) – részecskéből, 1 komponens
    \item 3D printing – részecske + kötőanyag
    \item FDM (ömledékrétegezés) – ömlesztés + szilárdítás
    \item Polyjet – térhálósítás lámpával
    \item SLA (sztereolitográfia) – térhálósítás lézerrel
    \item LOM (réteges kivágás és felépítés) – lapokból
  \end{itemize}
  \tcbline
...
\begin{question}{
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.6]{./static/3d-printing.png}
    \caption{3D printing\cite{bib:laborok}}
  ...
  hozzáférni, ezért a pontosság korlátozott. Az alapanyag szinte bármi lehet:
  kerámiák, fémek, polimerek (google: PLA, ABS, PC, PVA), kompozitok.
  \tcbline
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.5]{./static/fdm.png}
    \caption{Ömledékrétegezés\cite{bib:laborok}}
    \label{fig:omledek}
  \end{figure}
  ...
  alapanyaggal használható, viszont szerény pontosságú berendezés. Gyakran
  \textbf{támaszanyag} szükséges, ipari gépekben erre másik polimert
  használnak. Filamentanyag lehet: PLA, ABS, PC, PMMA, PEEK.
\end{question}
...
\begin{question}{
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.75]{./static/polyjet.png}
    \caption{Polyjet\cite{bib:laborok}}
    \label{fig:polyjet}
  \end{figure}
  A sugátzást egy $250\,\mathrm{W}$-os izzóval biztosítjuk
  (\textbf{UV-sugárzás}). Jó ár-érték arány, a legpontosabb eljárás, viszont
  időigényes, a berendezés drága, \textbf{támaszanyag} szükséges, melyet
  gyártás után mosássl távolíthatunk el. Alapanyag: Connex.
  \tcbline

  \underline{\textbf{\textit{Sztereolitográfia}}}: (SLA)
  \begin{figure}[H]
    \centering
    \includegraphics[scale=.75]{./static/SLA.png}
    \caption{Sztereolitográfia\cite{bib:laborok}}
    \label{fig:sla}
  \end{figure}
...
\begin{question}{
  ...
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}[scale=.9, ultra thick]
      \pie[
        rotate=240,
        % text=legend,
        % cloud,
...
\begin{question}{
  ...
  \begin{enumerate}
    ...
    \item szétválogatás
    \item aprítás (shredder – egytengelyes aprító)
...
\begin{thebibliography}{9}
  \bibitem{bib:eloadas}
  \textsc{Molnár Kolos} és \textsc{Mészáros László}
  – \emph{Polimertechnika} \emph{előadások} (BMEGEPTBM01)

  \bibitem{bib:laborok}
  \textsc{BME GPK Polimertechnika Tanszék}
  – \emph{Laborgyakorlati sillabuszok}

  % By Roland.chem - Own work, CC0, https://commons.wikimedia.org/w/index.php?curid=37866505
  \bibitem{bib:rojtos}
  \textsc{Ronald.chem}
  – \href{https://commons.wikimedia.org/w/index.php?curid=37866505}{\texttt{Wikipédia}}
\end{thebibliography}
